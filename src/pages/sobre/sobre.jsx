    ...
    return(
        <>
            <div 
                ...
                '>
                <div className='w-full h-auto py-5 flex bg-[#EFC3A4]/100'>
                    <div className='w-[55%] px-10 flex flex-col items-start'>
                        <h2 className='w-[85%] my-5 px-10 text-3xl text-[#4B1F0E] text-left font-semibold '>SOBRE NÓS</h2>
                        <p className='w-[85%] h-full px-10 text-lg text-[#4B1F0E] text-left font-semibold rounded-xl'>
                    ...
                    <div className='w-[40%] h-96 py-5'>
                        <img className='h-full rounded-xl border-2 border-[#4B1F0E]' src="./faixada2.jpg" alt="" />
                    </div>
                </div>
                <div className='w-full h-[30rem] pb-5 flex flex-col items-center'>
                    <h2 className='w-full my-5 text-3xl uppercase font-semibold text-[#4B1F0E]'>ONDE ESTAMOS</h2>  
                    <iframe className="w-[80%] h-full rounded-2xl border-2 border-[#4B1F0E]" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d363.5535819661969!2d-73.99932275185486!3d40.74966566850596!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259b9ec8df3b3%3A0xbabc9e1a561aa098!2sJoe%20Coffee%20Company!5e1!3m2!1spt-BR!2sbr!4v1735569698490!5m2!1spt-BR!2sbr" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
