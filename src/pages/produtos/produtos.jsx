...
export default function Produtos(){
    ...
    return(
        <>
            ...
            <div 
                id='produtos' 
                className='w-[100vw] h-auto pt-5 bg-[#EFC3A4] flex flex-wrap md:justify-center
                '>
                <div className="w-full flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 md:min-h-96 flex flex-col justify-start items-center">
                        <h2 className='h-[20%] py-3 md:py-0 flex items-center text-lg md:text-4xl uppercase font-semibold text-[#4B1F0E]'>
                            Cafés Gelados
                        </h2>
                ...
                <div className="w-full flex flex-col md:flex-row bg-[#4B1F0E]">
                    ...
                    <div className="w-full p-2 flex justify-around gap-1 order-1 md:order-2
                        ...
                        {doces.slice(0, 4).map((image, index) =>(
                            ...
                            >
                                ...
                                <div className={`
                                    absolute top-full w-full h-full flex justify-center items-center bg-[#4B1F0E]/80 rounded-lg 
                                    text-amber-100 text-[10px] md:text-xl uppercase font-semibold ${foco ? 'text-black' : ''}
                                    peer-hover:top-0 hover:top-0 transition-* duration-200
                                `}
                    ...
                    <div className={`w-full h-full md:w-[43vw] md:h-[60vh] flex justify-center items-center absolute bg-black/50 md:bg-black/0 md:z-0 overflow-y-hidden ${foco ? 'block md:left-[3.5vw]' : 'hidden md:-left-[3.5vw]'}`}>
                        <div className={`
                            md:w-[43vw] md:h-[60vh] md:mt-1 scale-[1%] opacity-0 bg-[#4B1F0E] rounded-2xl
                            w-full
